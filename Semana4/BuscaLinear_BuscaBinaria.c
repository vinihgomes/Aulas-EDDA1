...
int busca_linear (float n, float * notas);
int busca_binaria (float n, float * notas);
...
int busca_binaria (float n, float * notas){
	...
	int ini = 0, fim = TAMANHO_VETOR, meio, i;
	quick_sort(notas, ini, fim);
